...
ActiveRecord::Schema.define(version: 2021_03_25_145638) do
  ...
  create_table "track_concept_authorships", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["track_concept_id", "user_id"], name: "index_concept_authorship_on_track_concept_id_and_user_id", unique: true
  ...
  create_table "track_concept_contributorships", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["track_concept_id", "user_id"], name: "index_concept_contributorship_on_track_concept_id_and_user_id", unique: true
